    ...
    <div class="card-header p-0 position-relative mt-n4 z-index-2">
      <div class="row g-0 my-2 me-2">
        <div class="col-sm-6 col-md-8">
          <h6 class="text-capitalize ps-3 form-control-plaintext">Mantenimiento de roles</h6>
        </div>
        <div class="col-6 col-md-4 text-end">
          <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalNuevo">Nuev Rol</a>
        </div>
      </div>
    </div>
    <div class="card-body px-0 pb-2">
      <div class="table-responsive py-2 p-0 mx-4 ">
        <table id="tablaRoles" class="table align-items-center mb-0 table-bordered table-striped" style="width:100%">
          <thead>
            <tr>
              <th>#</th>
              <th>Nombre</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-normal">Nueva Rol</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success p-2 px-3" onclick="agregarRol()" data-bs-dismiss="modal">Agregar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body row mt-2">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="rol_id" hidden>
          <input type="text" class="form-control" id="rol_edit" placeholder="Nombre del rol">
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary p-2 px-3 shadow-secondary" data-bs-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-success p-2 px-3" onclick="editarRol()" data-bs-dismiss="modal">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<script src="../js/ajax/roles.js"></script>
<script>
