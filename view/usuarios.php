    ...
    <div class="card-header p-0 position-relative mt-n4 z-index-2">
      <div class="row g-0 my-2 me-2">
        <div class="col-sm-6 col-md-8">
          <h6 class="text-capitalize ps-3 form-control-plaintext">Mantenimiento de usuarios</h6>
        </div>
        <div class="col-6 col-md-4 text-end">
          <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalNuevo">Nueva Usuario</a>
        </div>
      </div>
    </div>
    <div class="card-body px-0 pb-2">
      <div class="table-responsive py-2 p-0 mx-4 ">
        <table id="tablaUsuarios" class="table align-items-center mb-0 table-bordered table-striped" style="width:100%">
          <thead>
            <tr>
              <th>#</th>
              <th>DNI</th>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <select id="rol_id" name="rol_id" class="form-control" required>
              ...
              <?php
              $datos = mysqli_query($db, "SELECT * FROM rol");
        ...
        <input type="text" id="empresa_id_edit" hidden>
          ...
          <div class="col-md-4">
            ...
            <select id="cargo_id_edit" name="cargo_id_edit" class="form-control" required>
              <?php
              $datos = mysqli_query($db, "SELECT * FROM cargo");
              foreach ($datos as $dato) { ?>
                <option value="<?= $dato['id']; ?>"><?= $dato['nombre']; ?></option>
              <?php } ?>
            </select>
